...
| Any of(Option)                                    |
| ------------------------------------------------- |
| [DocumentProcessor.json](#doc_processor_anyOf_i0) |

### <a name="doc_processor_anyOf_i0"></a>5.1. Property `DocumentProcessor.json`
...
| Property                                                    | Pattern | Type   | Deprecated | Definition                                   | Title/Description                          |
| ----------------------------------------------------------- | ------- | ------ | ---------- | -------------------------------------------- | ------------------------------------------ |
| - [implementation](#doc_processor_anyOf_i0_implementation ) | No      | const  | No         | -                                            | DocumentProcessor                          |
| - [parser](#doc_processor_anyOf_i0_parser )                 | No      | object | No         | In [DocumentParser](/docs/components/documentparser/overview)      | Overview of DocumentParser components      |
| - [splitter](#doc_processor_anyOf_i0_splitter )             | No      | object | No         | In [DocumentTransformer](/docs/components/documenttransformer/overview) | Overview of DocumentTransformer components |

#### <a name="doc_processor_anyOf_i0_implementation"></a>5.1.1. Property `implementation`
...
#### <a name="doc_processor_anyOf_i0_parser"></a>5.1.2. Property `parser`
...
| Any of(Option)                                             |
| ---------------------------------------------------------- |
| [AutoParser.json](#doc_processor_anyOf_i0_parser_anyOf_i0) |

##### <a name="doc_processor_anyOf_i0_parser_anyOf_i0"></a>5.1.2.1. Property `AutoParser.json`
...
| Property                                                                    | Pattern | Type  | Deprecated | Definition | Title/Description |
| --------------------------------------------------------------------------- | ------- | ----- | ---------- | ---------- | ----------------- |
| - [implementation](#doc_processor_anyOf_i0_parser_anyOf_i0_implementation ) | No      | const | No         | -          | AutoParser        |

###### <a name="doc_processor_anyOf_i0_parser_anyOf_i0_implementation"></a>5.1.2.1.1. Property `implementation`
...
#### <a name="doc_processor_anyOf_i0_splitter"></a>5.1.3. Property `splitter`
...
| Any of(Option)                                                    |
| ----------------------------------------------------------------- |
| [AutoTransformer.json](#doc_processor_anyOf_i0_splitter_anyOf_i0) |

##### <a name="doc_processor_anyOf_i0_splitter_anyOf_i0"></a>5.1.3.1. Property `AutoTransformer.json`
...
| Property                                                                      | Pattern | Type  | Deprecated | Definition | Title/Description |
| ----------------------------------------------------------------------------- | ------- | ----- | ---------- | ---------- | ----------------- |
| - [implementation](#doc_processor_anyOf_i0_splitter_anyOf_i0_implementation ) | No      | const | No         | -          | AutoTransformer   |

###### <a name="doc_processor_anyOf_i0_splitter_anyOf_i0_implementation"></a>5.1.3.1.1. Property `implementation`
