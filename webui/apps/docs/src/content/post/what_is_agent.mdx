...
A full reference to this example can be found at [Custom Agents](/docs/howto/custom_agents)
...
For more information on customizing components, see [Component Customization](/docs/howto/customize_builtins)
