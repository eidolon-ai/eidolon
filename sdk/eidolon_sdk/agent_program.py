...
class AgentIOState(BaseModel):
    ...
    def __init__(self):
        ...
        for key, value in self.transitions_to.items():
            self.transitions_to_models[key] = schema_to_model(value,
                                                              f'{self.state_name.capitalize()}To{key.capitalize()}OutputModel')
...
class AgentProgram(BaseModel):
    ...
    initial_state: str = Field(escription="The initial state of the program.")
