...
title: 'A historical view of transformational technologies'
...
that you surround yourself with defines the texture of your career. Talented people + good culture + good idea + timing == success. That equation 
defines the success of a startup, big or small. Some parts of the equation give rise to monetary success, some parts make the journey
much more enjoyable, some parts are just plain luck; however, all parts contribute to success. Create or join a company that does poorly
in one of these areas and your chances of a good exit decreases dramatically. Some people prefer monetary success, so they will put up with
a lot of BS to make a dime. Others prefer to focus on the people and are ok with a moderate outcome.

I've created or have been part of seven startups over my career, from 1994 - today. For the most part, except for one,
I've stuck with them through the good and bad times. All of these companies would be considered enterprise software companies. 
I've been a founder 2 times, hire #1 once, hired through an acquisition once, and employee < 30 the rest. I, clearly, prefer the startup
environment. I love the risk, but most importantly I love to create.

Over the years I've seen three major shifts in computing that have changed the way we think about applications, architecture, and
...
These three fundamental shifts in compute have led to amazing advances in how applications are delivered, how they are architected, how they
...
1. Emulate vt-100 over ethernet, anyone remember VSAM and VTAM, so it could be accessible from other computers. 
...
"What do people create with our product?", she said. Everyone looking confused, me included, replied "Web applications."
...
From 1996 to 2001 there was clear a revolution in how developers **thought** about applications, architecture and application
...
"presentation layer" and the "server layer". It was called "three tiered development" at the time, UI, server, and database. We extended
the concept of "database" to be generically "any data providing service", allowing us to integrate with other data sources, like 
transactional applications, directly. Think SAP and People Soft.

It wasn't the best architecture pattern, but it was a start.

## APIs and Data Services ##
In 2003, I joined a small startup called "Guidewire Systems". Guidewire is an insurance platform that is used by most insurance companies
...
I left Guidewire in 2010 and started a company with 3 other called "Paxata". Paxata was a data preparation platform that allowed
...
to scale to this level. We needed a lot of nodes. We needed a lot of nodes that could be spun up and down quickly.

I'm sure this level of online processing could not have been achieved without the cloud. We could have done it on-prem, but
...
that need to scale to 1000's of nodes is now a reality and that changes everything.
...
Instead of the sequential nature of Recurrent and Convolutional Neural Networks, we now had a way to scale the processing of
