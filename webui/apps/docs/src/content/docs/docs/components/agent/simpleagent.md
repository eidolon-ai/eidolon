...
- [1. Property `description`](#description)
- [2. Property `system_prompt`](#system_prompt)
- [3. Property `agent_refs`](#agent_refs)
  - [3.1. agent_refs items](#autogenerated_heading_2)
- [4. Property `actions`](#actions)
  - [4.1. ActionDefinition](#autogenerated_heading_3)
    - [4.1.1. Property `name`](#actions_items_name)
    - [4.1.2. Property `title`](#actions_items_title)
    - [4.1.3. Property `sub_title`](#actions_items_sub_title)
    - [4.1.4. Property `description`](#actions_items_description)
    - [4.1.5. Property `user_prompt`](#actions_items_user_prompt)
    - [4.1.6. Property `input_schema`](#actions_items_input_schema)
      - [4.1.6.1. Property `additionalProperties`](#actions_items_input_schema_additionalProperties)
    - [4.1.7. Property `output_schema`](#actions_items_output_schema)
      - [4.1.7.1. Property `item 0`](#actions_items_output_schema_anyOf_i0)
      - [4.1.7.2. Property `item 1`](#actions_items_output_schema_anyOf_i1)
    - [4.1.8. Property `allow_file_upload`](#actions_items_allow_file_upload)
    - [4.1.9. Property `supported_mime_types`](#actions_items_supported_mime_types)
      - [4.1.9.1. supported_mime_types items](#autogenerated_heading_4)
    - [4.1.10. Property `allowed_states`](#actions_items_allowed_states)
      - [4.1.10.1. allowed_states items](#autogenerated_heading_5)
    - [4.1.11. Property `output_state`](#actions_items_output_state)
- [5. Property `apu`](#apu)
  - [5.1. Property `implementation`](#apu_implementation)
- [6. Property `apus`](#apus)
  - [6.1. NamedAPU](#autogenerated_heading_6)
    - [6.1.1. Property `title`](#apus_items_title)
    - [6.1.2. Property `apu`](#apus_items_apu)
      - [6.1.2.1. Property `implementation`](#apus_items_apu_implementation)
    - [6.1.3. Property `default`](#apus_items_default)
- [7. Property `title_generation_mode`](#title_generation_mode)
- [8. Property `implementation`](#implementation)
...
### <a name="apu_implementation"></a>5.1. Property `implementation`
...
### <a name="autogenerated_heading_6"></a>6.1. NamedAPU
...
| - [apu](#apus_items_apu )         | No      | object  | No         | -          | -                 |
...
| Property                                            | Pattern | Type   | Deprecated | Definition | Title/Description |
| --------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [implementation](#apus_items_apu_implementation ) | No      | string | No         | -          | -                 |
| - [](#apus_items_apu_additionalProperties )         | No      | object | No         | -          | -                 |

##### <a name="apus_items_apu_implementation"></a>6.1.2.1. Property `implementation`
...
## <a name="implementation"></a>8. Property `implementation`
