...
- [6. Property `encoding_name`](#encoding_name)
- [7. Property `model`](#model)
- [8. Property `allowed_special`](#allowed_special)
...
- [9. Property `disallowed_special`](#disallowed_special)
