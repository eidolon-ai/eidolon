...
| ---------------------------------------------------- | ------- | ---------------------------- | ---------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [implementation](#implementation )                 | No      | const                        | No         | -                                     | GPTo1Preview                                                                                                                                                                                                                                                                                                                                                                            |
...
| **Required**   | No                                                                                                                                                                                                                |
| **Default**    | `{"implementation": "ToolCallLLMWrapper", "llm_unit": {"implementation": "OpenAIGPT", "temperature": 1, "supports_system_messages": false, "can_stream": false, "force_json": false, "model": "gpt-o1-preview"}}` |
