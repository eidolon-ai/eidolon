...
from eidos.cpu.agent_io import SystemCPUMessage, UserTextCPUMessage, CPUMessageTypes
from eidos.cpu.llm_message import UserMessage, LLMMessage
from eidos.agent.tot_agent.prompts import POST_AMBLE, THOUGHTS, PREAMBLE, POST_AMBLE_MULTI
