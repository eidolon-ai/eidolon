...
| Gemini | Google <a href="https://aistudio.google.com/app/apikey" target="_blank">API Keys</a> and <a href="https://console.cloud.google.com/apis/api/generativelanguage.googleapis.com/metrics" target="_blank">usage<a> | GEMINI_API_KEY                |
...
GEMINI_API_KEY=yourgoogleapikey
```
