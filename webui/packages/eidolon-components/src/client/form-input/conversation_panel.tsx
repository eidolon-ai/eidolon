...
export function CopilotPanel({
                               machineUrl, agent, processId, copilotParams, userName, userImage, afterExecute,
  ...
  return (
    ...
    >
      <EidolonEvents scrollableRegionRef={scrollableRegionRef} machineUrl={machineUrl} agentName={agent} elementsAndLookup={elementsAndLookup}
