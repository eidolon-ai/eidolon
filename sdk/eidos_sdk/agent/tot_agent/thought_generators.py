...
from eidos_sdk.cpu.agent_io import SystemCPUMessage, UserTextCPUMessage, CPUMessageTypes
from eidos_sdk.cpu.llm_message import UserMessage, LLMMessage
from eidos_sdk.agent.tot_agent.prompts import (
    POST_AMBLE,
    THOUGHTS,
    PREAMBLE,
    POST_AMBLE_MULTI,
